...
public class Utils {
     ...
     *
     * @param d the value to be transformed
     ...
     * @param wait <code>true</code> to wait after displaying the list,
     ...
     * @param wait            <code>true</code> to wait after displaying the list,
     *                        <code>false</code> otherwise.
     * @param excludeElements Excludes the elements that exist in this list from the list
     ...
     *
     * @param list   The list from which a selection will be made.
     * @param cancel <code>true</code> to allow canceling the selection,
     *               <code>false</code> otherwise.
     ...
     *
     * @param list           The list from which selections will be made.
     * @param cancel         <code>true</code> to allow canceling the selection,
     *                       <code>false</code> otherwise.
     * @param multipleReturn <code>true</code> to allow the array to contain multiple selections,
     *                       <code>false</code> otherwise.
     ...
     * @param multipleReturn  <code>true</code> to allow the array to contain multiple selections,
     *                        <code>false</code> otherwise.
     * @param excludeElements Elements from the list to be excluded.
     * @return A list with one or multiple selected elements from the list.
     */
     ...
     *
     * @param arr an array of elements of type {@link String}
     ...
     * otherwise.
     *
     * @param i    The index passed as a parameter
