...
public class Halcon extends Ave {
    ...
    public Halcon(int altura, int peso, int edad, String habitat, String color, String pies, String nombreCientifico, String nombreAnimal, String territorio, String sonido) {
