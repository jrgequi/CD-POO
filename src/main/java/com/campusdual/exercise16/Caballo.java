...
public class Caballo extends Mamifero {
    ...
    public Caballo(int altura, int peso, int edad, String habitad, String color, String pies, String nombreCientifico, String nombreDelAnimal, String territorio, String sonido) {
